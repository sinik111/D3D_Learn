...
void NormalMappingApp::Initialize()
{
	m_width = 1280;
	m_height = 720;
...
void NormalMappingApp::OnShutdown()
{
	ShutdownImGui();
}
...
void NormalMappingApp::InitializeImGui()
{
	IMGUI_CHECKVERSION();
...
void NormalMappingApp::InitializeScene()
{
...
void NormalMappingApp::ShutdownImGui()
{
...
LRESULT NormalMappingApp::MessageProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
